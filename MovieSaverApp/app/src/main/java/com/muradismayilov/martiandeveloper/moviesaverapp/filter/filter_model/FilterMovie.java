package com.muradismayilov.martiandeveloper.moviesaverapp.filter.filter_model;
...
public class FilterMovie {
    ...
    public FilterMovie(int id, String title, float vote_average, String release_date, String original_title, String poster_path) {
        this.id = id;
        this.title = title;
