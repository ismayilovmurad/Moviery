...
public class TvDetailNextEpisodeToAir {
    ...
    public TvDetailNextEpisodeToAir(String air_date, int episode_number, String name, String overview, int season_number, String still_path, float vote_average, int vote_count) {
