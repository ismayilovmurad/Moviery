...
public class PersonPopularFragment_ViewBinding implements Unbinder {
  private PersonPopularFragment target;

  @UiThread
  public PersonPopularFragment_ViewBinding(PersonPopularFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PersonPopularFragment target = this.target;
