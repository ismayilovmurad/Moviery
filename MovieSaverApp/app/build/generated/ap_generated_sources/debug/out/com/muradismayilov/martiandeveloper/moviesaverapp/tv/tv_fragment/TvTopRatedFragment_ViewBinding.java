...
public class TvTopRatedFragment_ViewBinding implements Unbinder {
  private TvTopRatedFragment target;

  @UiThread
  public TvTopRatedFragment_ViewBinding(TvTopRatedFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TvTopRatedFragment target = this.target;
