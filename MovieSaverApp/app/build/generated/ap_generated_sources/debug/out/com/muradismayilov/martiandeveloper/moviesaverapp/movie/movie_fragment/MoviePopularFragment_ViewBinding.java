...
public class MoviePopularFragment_ViewBinding implements Unbinder {
  private MoviePopularFragment target;

  @UiThread
  public MoviePopularFragment_ViewBinding(MoviePopularFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MoviePopularFragment target = this.target;
