...
public class ProfileActivityPerson_ViewBinding implements Unbinder {
  private ProfileActivityPerson target;

  @UiThread
  public ProfileActivityPerson_ViewBinding(ProfileActivityPerson target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ProfileActivityPerson_ViewBinding(ProfileActivityPerson target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProfileActivityPerson target = this.target;
