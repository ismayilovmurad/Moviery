...
public class ProfileActivityMovie_ViewBinding implements Unbinder {
  private ProfileActivityMovie target;

  @UiThread
  public ProfileActivityMovie_ViewBinding(ProfileActivityMovie target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public ProfileActivityMovie_ViewBinding(ProfileActivityMovie target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ProfileActivityMovie target = this.target;
