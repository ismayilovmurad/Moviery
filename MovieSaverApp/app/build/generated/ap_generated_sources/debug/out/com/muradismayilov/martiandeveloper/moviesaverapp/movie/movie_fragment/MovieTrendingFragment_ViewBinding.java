...
public class MovieTrendingFragment_ViewBinding implements Unbinder {
  private MovieTrendingFragment target;

  @UiThread
  public MovieTrendingFragment_ViewBinding(MovieTrendingFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MovieTrendingFragment target = this.target;
