...
public class TvPopularFragment_ViewBinding implements Unbinder {
  private TvPopularFragment target;

  @UiThread
  public TvPopularFragment_ViewBinding(TvPopularFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TvPopularFragment target = this.target;
