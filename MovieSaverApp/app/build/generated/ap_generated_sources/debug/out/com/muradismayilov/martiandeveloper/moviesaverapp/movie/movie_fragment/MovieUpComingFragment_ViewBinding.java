...
public class MovieUpComingFragment_ViewBinding implements Unbinder {
  private MovieUpComingFragment target;

  @UiThread
  public MovieUpComingFragment_ViewBinding(MovieUpComingFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MovieUpComingFragment target = this.target;
