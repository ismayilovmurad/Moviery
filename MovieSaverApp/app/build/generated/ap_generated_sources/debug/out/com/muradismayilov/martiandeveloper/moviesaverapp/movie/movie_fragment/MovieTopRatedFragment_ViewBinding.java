...
public class MovieTopRatedFragment_ViewBinding implements Unbinder {
  private MovieTopRatedFragment target;

  @UiThread
  public MovieTopRatedFragment_ViewBinding(MovieTopRatedFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    MovieTopRatedFragment target = this.target;
