...
public class TvDetailActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public TvDetailActivity_ViewBinding(TvDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TvDetailActivity_ViewBinding(TvDetailActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TvDetailActivity target = this.target;
