...
public class PersonTrendingFragment_ViewBinding implements Unbinder {
  private PersonTrendingFragment target;

  @UiThread
  public PersonTrendingFragment_ViewBinding(PersonTrendingFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PersonTrendingFragment target = this.target;
