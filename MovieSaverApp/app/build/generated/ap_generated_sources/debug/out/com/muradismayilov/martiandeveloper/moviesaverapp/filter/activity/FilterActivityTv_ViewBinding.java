...
public class FilterActivityTv_ViewBinding implements Unbinder {
  private FilterActivityTv target;

  @UiThread
  public FilterActivityTv_ViewBinding(FilterActivityTv target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FilterActivityTv_ViewBinding(FilterActivityTv target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FilterActivityTv target = this.target;
